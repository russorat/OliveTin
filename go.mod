...
require (
	...
	github.com/ngrok/libngrok-go v0.0.0-20220909154412-fe6c40f2e674
...
replace github.com/ngrok/libngrok-go/log v0.0.0 => github.com/ngrok/libngrok-go/log v0.0.0-20220909154412-fe6c40f2e674
